...
const items = [
    {
      src: require ('../../Images/estacionamiento1.jpg'),
      altText: 'Imagen 1',
...
import img1 from '../../recursos/estacionamiento1.jpg'
import img2 from '../../recursos/estacionamiento2.png'
import img3 from '../../recursos/estacionamiento3.jpg'
            ...
            <div id="carouselExampleAutoplaying" className="carousel slide" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={img1} className="d-block w-80" alt=".1" />
                    </div>
                    <div className="carousel-item">
                        <img src={img2} className="d-block w-80" alt=".2" />
                    </div>
                    <div className="carousel-item">
                        <img src={img3} className="d-block w-80" alt=".3" />
                    </div>
                </div>
