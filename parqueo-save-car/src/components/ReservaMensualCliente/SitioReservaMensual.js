...
const SitioReservaMensual = (props) => {
  ...
  return (
    <div>
        ...
        <Modal isOpen={modalEstado} centered={true}>
          ...
          <ModalBody>
            <select>
                <option disabled selected>Elige la tarifa</option>
                <option>Mes Día (06:00-22:00) 400 Bs.</option>
                <option>Mes Noche (21:00-07:00) 300 Bs.</option>
                <option>Mes Completo (24:00 horas) 600 Bs.</option> 
            </select>
            <EntradaInput
              titulo="Placa"
              nombre='placa'
...
export default SitioReservaMensual